...
def create_premium_presentation():
    ...
    p_title.text = "PROTEGIENDO VILLA EL BOSQUE"
    p_title.font.name = "Arial"
    ...
    add_notes(s3, "Postulamos en abril de 2024. La espera administrativa generó incertidumbre. Router estuvo constantemente explicando detalles técnicos para dar tranquilidad, cimentando una confianza mutua que permitió resolver rápido la entrega de nueva documentación exigida por el GORE a última hora. Los fondos se adjudicaron a fines de 2025 y llegaron en febrero de 2026.")
    ...
    add_notes(s5, "Para asegurar que el sistema sea realmente efectivo, se contempló un ítem de Recursos Humanos por $300.000 para la realización de charlas de capacitación y prevención. Estas actividades están a cargo de un experto en seguridad, que puede ser un ingeniero en prevención de riesgos o un ex-funcionario de las Fuerzas Armadas especialista en la materia. Su rol es educar a los vecinos en el autocuidado, prevención del delito y uso responsable de las grabaciones del sistema, acompañando el encuentro con coffee breaks para fortalecer la cohesión vecinal.")
    ...
    p_s_map_l2.text = "• 16 Cámaras IP Bullet:\n" \
                      "  Distribuidas de manera uniforme para maximizar la cobertura en todos los accesos principales, pasajes internos y áreas comunes de Villa El Bosque.\n\n" \
    ...
    p_s10_l2.text = "• Encargado Designado: Directiva / Vecino Coordinador.\n\n" \
                   "• Funciones Clave:\n" \
    ...
    # Right Column: Photo Card (Using real photo of neighbors!)
    insert_image_with_card(s10, 6.8, 1.8, 5.7, 4.8, "real_neighbors.jpg", accent_color=c_orange)

    add_notes(s10, "Un sistema de seguridad comunitario requiere una persona de absoluta confianza a cargo de los equipos para garantizar la privacidad y el uso responsable. La asamblea y la directiva asignarán formalmente esta importante labor a un vecino encargado o coordinador de seguridad. Esta persona será el custodio técnico de la central de monitoreo, velando por que los equipos funcionen correctamente y actuando bajo un estricto principio de confidencialidad y respeto a la privacidad de todas las familias.")
    ...
    add_notes(s11, "Para resguardar el derecho a la privacidad de todos los hogares, hemos diseñado un protocolo formal y transparente de acceso a las grabaciones. Las cámaras no son para 'espiar' el día a día del barrio; son para proteger. Por lo tanto, si un vecino necesita revisar una grabación debido a un robo, choque, daño o cualquier ilícito, no debe acudir directamente al cuidador técnico. El canal correcto es presentar una solicitud formal ante la Directiva de la Junta de Vecinos. La directiva analizará el caso de forma reservada, autorizará la extracción del video de la fecha y hora indicadas, y el encargado procesará el clip para que sea enviado de manera rápida y segura vía WhatsApp al vecino o directamente a las policías como medio de prueba para la denuncia formal.")
    ...
    p_s12_s3_b.text = "La directiva aprueba y canaliza la solicitud con el encargado técnico, quien extrae el fragmento de video y lo envía de forma segura vía WhatsApp."
    ...
    p_w1_b.text = "• Plazo de Cobertura: 6 meses de garantía a partir del inicio de la operación.\n\n" \
    ...
    add_notes(s14, "Nuestra empresa Router se hace cargo de una garantía oficial por 6 meses que comenzará a regir desde la entrega oficial del sistema. Esto cubre fallas técnicas de fábrica o desperfectos en el montaje de los equipos. Es sumamente importante recalcar que esta garantía no contempla daños provocados por la manipulación no autorizada de terceros, ni actos de vandalismo o robos de las cámaras. Debemos comprometernos como comunidad a cuidar de este gran activo.")
    ...
    p_s15_2.text = "Tu opinión y tus dudas son muy importantes.\n\n" \
                  "Por favor, levanta la mano y comparte tus inquietudes con la Directiva de la Junta de Vecinos de Villa El Bosque y el Equipo Técnico de Router."
    ...
    add_header(s16, "¡Villa El Bosque Unida en Redes Sociales!")
    ...
    p_sp_l3.text = "• Cámara de Alta Gama: Full HD, visión nocturna, audio.\n" \
                   ...
                   "• Vigencia Limitada: Promoción válida solo hasta el 5 de Agosto de 2026."
    ...
    p_agrad_body.text = "• Gobierno Regional del Biobío (GORE Biobío)\n" \
                        "• Directiva Junta de Vecinos Villa El Bosque\n" \
                        "• A todos los Vecinos y Vecinas de Villa El Bosque"
    ...
    p_contact_sub.text = "Router Soluciones Tecnológicas"
    ...
    # Save presentation
    output_path = "/Users/ricardomarimodinger/.gemini/antigravity/scratch/ricardo-ai-system/data/router_seguridad/bitacora/2026-07-06_presentacion_villa_el_bosque.pptx"
