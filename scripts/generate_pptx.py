...
def create_premium_presentation():
    ...
    p_badge.text = "FONDO SEGURIDAD CIUDADANA  •  CÓDIGO 2024SC0170"
    ...
    p_title.text = "PROTEGIENDO VILLA ALESSANDRI"
    p_title.font.name = "Arial"
    ...
    p_s_map_l2.text = "• 16 Cámaras IP Bullet:\n" \
                      "  Distribuidas de manera uniforme para maximizar la cobertura en todos los accesos principales, pasajes internos y áreas comunes de la población Jorge Alessandri.\n\n" \
    ...
    p_s10_l2.text = "• Encargado Designado: Don Oscar Palma.\n\n" \
                   "• Funciones Clave:\n" \
    ...
    # Right Column: Photo Card (Using real photo of Don Oscar Palma and neighbors!)
    insert_image_with_card(s10, 6.8, 1.8, 5.7, 4.8, "real_neighbors.jpg", accent_color=c_orange)

    add_notes(s10, "Un sistema de seguridad comunitario requiere una persona de absoluta confianza a cargo de los equipos para garantizar la privacidad y el uso responsable. La asamblea y la directiva han asignado formalmente esta importante labor a nuestro vecino, Don Oscar Palma. Don Oscar será el custodio técnico de la central de monitoreo, velando por que los equipos funcionen correctamente y actuando bajo un estricto principio de confidencialidad y respeto a la privacidad de todas las familias.")
    ...
    add_notes(s11, "Para resguardar el derecho a la privacidad de todos los hogares, hemos diseñado un protocolo formal y transparente de acceso a las grabaciones. Las cámaras no son para 'espiar' el día a día del barrio; son para proteger. Por lo tanto, si un vecino necesita revisar una grabación debido a un robo, choque, daño o cualquier ilícito, no debe acudir directamente a Don Oscar Palma. El canal correcto es presentar una solicitud formal ante la Directiva de la Junta de Vecinos. La directiva analizará el caso de forma reservada, autorizará la extracción del video de la fecha y hora indicadas, y Don Oscar procesará el clip para que sea enviado de manera rápida y segura vía WhatsApp al vecino o directamente a las policías como medio de prueba para la denuncia formal.")
    ...
    p_s12_s3_b.text = "La directiva aprueba y canaliza la solicitud con Don Oscar Palma, quien extrae el fragmento de video y lo envía de forma segura vía WhatsApp."
    ...
    add_notes(s14, "Nuestra empresa Router se hace cargo de una garantía oficial por 6 meses que comenzó a regir desde el primero de mayo de este año. Esto cubre fallas técnicas de fábrica o desperfectos en el montaje de los equipos. Es sumamente importante recalcar que esta garantía no contempla daños provocados por la manipulación no autorizada de terceros, ni actos de vandalismo o robos de las cámaras. Debemos comprometernos como comunidad a cuidar de este gran activo.")
    ...
    p_s15_2.text = "Tu opinión y tus dudas son muy importantes.\n\n" \
                  "Por favor, levanta la mano y comparte tus inquietudes con la Directiva de la Junta de Vecinos Jorge Alessandri y el Equipo Técnico de Router."
    ...
    add_header(s16, "¡Villa Alessandri Unida en Redes Sociales!")
    ...
    p_sp_l3.text = "• Cámara de Alta Gama: Full HD, visión nocturna, audio.\n" \
                   ...
                   "• Vigencia Limitada: Promoción válida solo hasta el 5 de Junio de 2026."
    ...
    p_agrad_body.text = "• Gobierno Regional del Biobío (GORE Biobío)\n" \
                        "• Directiva Junta de Vecinos Población Jorge Alessandri\n" \
                        "• A todos los Vecinos y Vecinas de Villa Alessandri"
    ...
    # Save presentation
    output_path = "/Users/ricardomarimodinger/.gemini/antigravity/scratch/ricardo-ai-system/presentacion_villa_alessandri.pptx"
